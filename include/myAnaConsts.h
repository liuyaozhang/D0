...
namespace ana{
   const int nuofY = 1;
   const float ybin[nuofY+1] = {0, 1.5};
   const std::string whichtree[] = {"d0ana", "npd0ana", "npd0ana1", "npd0ana2"};
   const std::string whichbk[] = {"BDTCutNewMassPeak", "BDTCutNewSB", "BDTCutNew", "BDTCutNew_pp"}; 
   
   const int bk_mode = 3; 
   const double pTMin = 7.0;
   const double pTMax = 8.0;
   const double yMin  = 0.0;
   const double yMax  = 1.5;

   const double mvaMin = -0.3;
   
   const double mvaMax = 0.70;
